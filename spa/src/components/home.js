        ...
        return (
            <div className="home-outer-container">
                <div className="home-intro">
                    ...
                    <h3>About this SPA</h3>
                    <p>This responsive SPA is build with React.JS and served over Amazon web service.</p>
                    ...
                    <p>Click on the "SPA" in the nav bar for more information about this SPA.</p>
                </div>
